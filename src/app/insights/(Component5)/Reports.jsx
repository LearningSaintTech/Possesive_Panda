...
const Reports = () => {
  return (
    <div className='ml-4 mr-4 lg:mt-[9.259vh]  lg:ml-[5.729vw] lg:mr-[5.729vw] mt-[75%]'>
      <h1 className='text-neutral-800 text-3xl lg:text-[40px] font-medium capitalize tracking-normal  mb-10  lg:mb-[12.259vh]'>The Latest Reports from the panda research Institute</h1>
