...
const ReshapeItems = ({ image, heading, para }) => {
  return (
    <div className='relative  w-screen'>
        ...
        <div className='bg-neutral-50 border rounded-[10px] absolute lg:top-[13%] lg:left-[6.7%] lg:right-[50.5%] top-[70%] left-[10%] right-[10%] h-fit lg:h-[19.871vw] pb-[3vw] lg:pb-[2.778vh]'>
          <h5 className='text-neutral-800 text-[4.5vw] max-[425px]:mt-[10%] lg:text-[1.667vw] font-medium capitalize tracking-normal lg:ml-[2.083vw] mt-[3vw] text-center lg:text-start md:text-2xl'>
            {heading}
          </h5>
          ...
          <button className="bg-neutral-50 text-neutral-800 lg:text-[1.25vw] lg:top-[76%] text-[4vw] lg:font-medium font-medium flex justify-center items-center rounded-[70px] lg:py-[2.5vh] lg:px-[2vw] border border-black px-[4vw] py-[2.5vw] mx-auto mt-[2.5vh] lg:mx-0 lg:absolute  lg:right-[2vw] md:text-xs md:px-[1.5vw] md:py-[1.5vw]">
            Read More
            <svg
              width="19"
              height="15"
