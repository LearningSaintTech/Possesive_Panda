        ...
        <div className='mt-36 flex flex-col lg:flex-row justify-between mx-4 lg:mx-36'>
            <div className='flex flex-col w-full lg:w-[1110px]'>
                <div className='flex flex-col p-6 lg:p-12'>
                    ...
                    <div>
                        <p className='mt-8 text-neutral-800 text-2xl lg:text-[40px] font-semibold'>We Would love to share a similar experience</p>
                        <p className='mt-8'>I believe in the power of design.</p>
                        <p className='mt-8'>Design brings ideas, messages, and emotions to life. Design helps us communicate and connect in purpose-filled ways. Design influences what we think and feel. Design informs the decisions we make. At our core, we all seek purpose. Many of us want our daily decisions to help make the world a better place.</p>
                        <p className='mt-8'>Organizations that aspire to benefit humanity touch us. They galvanize communities dedicated to good. Sometimes, they even launch extraordinary movements.</p>
                    ...
                    <div>
                        ...
                        <p className='mt-8'>When I first moved to Israel, I began working with an organization that helps new immigrants find professional success by providing education about the job market, courses, networking, and introductions to major companies. Our goal was to create a new strategy and website that met their audience’s many needs.</p>
                        <p className='mt-8'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy.</p>
                        <p className='mt-8'>And ever since then, we at Verticalloop have embraced our mission to “design for good.”</p>
                    </div>
                    ...
                    <div className='flex flex-wrap items-center'>
                        ...
                        <p className='bg-cyan-300 rounded-lg ml-4 mt-2 lg:mt-0 text-center px-4 py-1'>Design</p>
                        <p className='bg-cyan-300 rounded-lg ml-4 mt-2 lg:mt-0 text-center px-4 py-1'>Branding</p>
                        <p className='bg-cyan-300 rounded-lg ml-4 mt-2 lg:mt-0 text-center px-4 py-1'>Agency</p>
                    </div>
                    ...
                    <div className="bg-neutral-50 rounded-lg mt-[100px] p-6 lg:p-12">
                        ...
                        <div className="mt-8">
                            ...
                            <form className="space-y-4">
                                ...
                                <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded-md">Post Comment</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-[501.63px] sticky top-36 h-full  ">
                <div className=' pt-[50.4px] pl-[40px] bg-neutral-50 rounded-[10.20px] shadow border border-black/50'>
                    <div className="text-neutral-800 text-[32px] font-semibold font-['Poppins'] leading-[29.33px] tracking-tight">Recent Post</div>
