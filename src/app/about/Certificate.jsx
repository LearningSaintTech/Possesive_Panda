...
const Certificate = () => {
  return (
    <div className="bg-sky-200 px-[2.5vw] lg:px-0 flex flex-col  items-center relative z-[10] overflow-hidden gap-[3.5vw] lg:gap-[1.25vw] lg:min-h-[100vh] lg:max-h-[180vh] lg:mb-[400px]">
