    ...
    <div className=' bg-[#00111A] pt-[5.052vw] pb-[5.052vw] px-[5.469vw] '   >
      <div className=' bg-[#131D22]  sm:w-[89.583vw] flex flex-row  gap-[0.5vw] ' >
        ...
        <div className='flex flex-col  ml-[2.604vw] py-[1.25vw] mt-[3vw] '>
          ...
          />
          <div>
            <p className='text-white sm:mt-[2.083vw] text-[5.647vw] sm:text-[1.379vw] font-medium sm:font-extrabold '>Our Purpose</p>
      ...
      <div className=' bg-[#00111A] sm:h-[30vw]  w-full sm:w-[89.583vw] mt-[1.563vw] flex flex-col sm:flex-row gap-[2.5vw] '>
        ...
        <div className='bg-[#131D22] sm:h-[30vw] sm:w-[50.441vw] flex flex-row gap-[3.125vw] ' >
          ...
          <Image src={image2}
            alt="image2"
            className='  w-[18.892vw] mt-18 hidden md:block' />
        </div>
