  ...
  return (
    <div className="px-[7.692vw] sm:px-[5.2vw] mt-[10.5vw]">
      <div className="flex sm:flex-row flex-col justify-between">
        <h4 className="text-[#212121] text-[5.128vw] sm:text-[2.083vw] font-semibold leading-[130%] tracking-[0.03rem] text-center lg:text-left sm:mb-0 mb-[2vw]">
          Brands That Trust Us
        </h4>
        <p className="text-[#212121] text-[3.846vw] sm:text-[1.25vw] leading-[160%] tracking-[0.015rem] text-justify opacity-85 w-full sm:w-[45vw]">
