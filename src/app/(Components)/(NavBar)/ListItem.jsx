...
const ListItem = ({ name, clickFunction, link, selected }) => {
  ...
  const hoverClasses =
    "hover:bg-[#60E2FF] hover:border-l-[0.4vw] hover:border-sky-500 hover:text-white";
  const selectedClasses =
    "bg-[#60E2FF] border-l-[0.4vw] border-sky-500 text-white";
  const headClasses =
    "text-[1.25vw] font-medium leading-[normal] tracking-[0.013vw]";
  const childClasses =
    "text-[1.024vw] font-medium leading-[normal] tracking-[0.013rem]";
  return (
    <button
    ...
    >
      ...
      {name === "Premium Services" && (
        ...
        >
          <path d="M5 8L12.5 16L20 8H5Z" fill="white" />
        </svg>
