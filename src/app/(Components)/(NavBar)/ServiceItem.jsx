...
const ServiceItem = ({ name }) => {
  ...
  if (name == "Technical Support & Troubleshooting") {
    firstPart = "Technical Support &";
    secondPart = "Troubleshooting";
  }
  if (name == "Operations & Supply Management") {
    firstPart = "Operations & Supply";
    secondPart = "Management";
  }
  if (name == "Finance & Accounting Outsourcing") {
    firstPart = "Finance & Accounting";
    secondPart = "Outsourcing";
  }
  return (
    <div className="relative rounded-[0.3vw] border-l border-black border-opacity-20 pl-[1.563vw] pr-[4.7vw] h-[6.771vw]">
      <h5 className="text-neutral-800 hover:text-cyan-300 hover:font-bold text-[1.042vw] my-[1.823vw] font-medium leading-[normal] tracking-[0.013rem] h-fit w-[12vw] cursor-pointer">
        {firstPart}
        <br />
        {secondPart}
      </h5>
