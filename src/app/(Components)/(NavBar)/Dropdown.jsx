...
//     <div
//       ref={dropdownRef}
//       className={`absolute flex gap-[2.344vw] top-[4.3vw] bg-gray-500 pl-[3.646vw] py-[2.083vw] pr-[3.6vw] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[0.2vw] w-[90vw] h-[31.5vw] ${
...
const Dropdown = ({ showDropdown, setShowDropdown }) => {
  ...
  return (
    <div
      ref={dropdownRef}
      className={`absolute flex gap-[2.344vw] top-[4.3vw] ${
        isHomePage ? "bg-gray-500" : "bg-white"
      } pl-[3.646vw] py-[2.083vw] pr-[3.6vw] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[0.2vw] w-[90vw] h-[31.5vw] ${
        showDropdown ? "block" : "hidden"
      }`}
      onMouseLeave={() => setShowDropdown(false)}
    >
