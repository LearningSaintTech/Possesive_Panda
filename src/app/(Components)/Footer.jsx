...
const Footer = () => {
  return (
    <footer className="ml-[5.2vw] lg:ml-[5.2vw] mt-[200px] relative">
      <div className=" w-fit flex flex-col lg:flex-row mx-auto lg:mx-0">
        <div className="w-full lg:w-[29vw] mx-auto lg:mx-0">
          <h1 className="text-zinc-800 text-[5vw] lg:text-[3.333vw] font-medium leading-[125%] tracking-[0.167vw]">
            Possessive
          </h1>
          <div className="flex">
            <h1 className="text-zinc-800 text-[5vw] lg:text-[3.333vw] font-medium leading-[125%] tracking-[0.167vw] lg:mr-[0.417vw] lg:mb-[84px]">
              Panda
            </h1>
            <button className="h-fit">
              <Image
                src={downButton}
                alt="down-arrow"
                className="size-[8vw] lg:size-auto lg:h-fit lg:mt-4"
              />
            </button>
          </div>

          <h5 className="text-zinc-900 text-[3vw] lg:text-[1.25vw] font-medium leading-[125%] tracking-[0.076rem] lg:mb-[20px]">
            Get In Touch With Us
          </h5>
          <div className="flex bg-[#FAFAFA] border rounded-[5px] w-fit px-[2vw] items-center lg:mb-[53px]">
            <input
              type="text"
        ...
        <div className="w-fit">
          ...
          <div className="flex mt-[33px] w-[13.021vw] justify-between">
            ...
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_1408_5152)">
                <path
      ...
      <Image
        src={panda}
        alt="panda"
        className="absolute bottom-[4px] right-[1.5vw] hidden lg:block"
      />
      <Image
        src={grey}
        alt="grey"
