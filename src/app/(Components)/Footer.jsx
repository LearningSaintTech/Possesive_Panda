...
const Footer = () => {
  return (
    <footer className="sm:ml-[6.771vw] mt-[50px] sm:mt-[6vw] relative">
        ...
        <div className="w-full sm:w-[29vw] mx-auto sm:mx-0">
          ...
          <div className="ml-7 sm:ml-0">
            <Link href="mailto:hello@possesivepanda.com">
              ...
              <MdOutlineEmail className="size-[5.5vw] sm:size-[1.6vw] " />
      ...
      <h1 className="mt-[1.3vw] text-[3vw] sm:text-[1.25vw] leading-[183%] text-[#2A2A2A] tracking-[0.03rem] pb-[1vw] mx-auto sm:mr-0 sm:ml-[20.833vw] w-fit">
