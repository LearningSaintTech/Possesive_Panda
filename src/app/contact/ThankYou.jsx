    ...
    return (
        <div className='sm:px-[5.208vw] px-[7.059vw]'>
            <div className="sm:w-[89.583vw] w-[85.882vw] relative bg-white/10 rounded-[1.563vw] flex justify-center items-center flex-col sm:py-[4.531vw] py-[7.529vw]">
                <h6 className="sm:w-[42.656vw] w-[74.588vw] text-center text-white sm:text-[2.5vw] text-[7.529vw] font-semibold sm:mb-[0.833vw] mb-[1.882vw]">Thank you for your Interest in Possessive panda</h6>
