...
const JoinPanda = () => {
  return (
    <div className="m-[5.2vw] relative">
      <Image
        src={Hand}
        alt="Background"
        objectFit='cover' className=''
      />
      <div className='absolute top-0 flex mx-[11.302vw] justify-between w-[67vw]'>
        <div className="my-auto flex flex-col gap-[1.042vw]">
          ...
          <button className="text-white bg-sky-500 py-[0.651vw] px-[2.24vw] rounded-full font-medium text-[1.25vw] w-fit">
            Join Panda
          </button>
        </div>
        <Image
          src={tech}
          alt="Tech Image"
          className="rounded-full size-[26vw] mt-0.5 md:mt-2"
        />
      </div>
    </div>
  );
