...
const Portfolio = () => {
  return (
    <div className="py-[7vw] px-[5.2vw] lg:px-[7.5vw] bg-black text-white rounded-t-[2.083vw] relative">
      <div className="md:w-[32.292vw] flex flex-col justify-around min-h-[25vh] md:min-h-[60vh] md:sticky md:top-[200px] z-[1]">
        <h5 className="text-[2.5vw] lg:text-[1.25vw] tracking-[0.015rem]">
          Our Portfolio
        </h5>
        <h2 className="text-[5vw] lg:text-[3.333vw] font-medium tracking-[0.04rem]">
          Featured Works
        </h2>
        <p className="text-[#F9F9F9] font-normal text-[2.5vw] lg:text-[1.25vw] tracking-[0.015rem] w-[50vw] md:w-fit">
        ...
        <button className="bg-stone-900 text-[2.5vw] lg:text-[1.25vw] flex justify-center font-normal items-center rounded-[5vw] md:rounded-[3.4vw] border border-neutral-600 text-white px-[3vw] py-[2.5vw] md:py-[1vw] w-[30vw] md:w-[15vw]">
          Lets Start
          <svg
            width="19"
            height="15"
            ...
            className="ml-2 md:ml-5 size-[3.5vw] md:size-[0.8vw]"
          >
            <path
      ...
      <div className="md:absolute md:top-[140px] md:right-[7.5vw] md:mb-[100px]">
        <Image
          src={portfolio_1}
          alt="portfolio-1"
          className="size-[83vw] md:h-auto md:w-auto mt-[40px] md:mt-0 mx-auto lg:mx-0"
        />
      </div>
      <div className="flex flex-col md:flex-row justify-between md:mt-[300px] relative z-[10]">
        <Image
          src={portfolio_1}
          alt="portfolio-1"
          className="size-[83vw] md:h-[35vw] md:w-[40vw] mt-[40px] md:mt-0 mx-auto lg:mx-0"
        />
        <Image
          src={portfolio_2}
          alt="portfolio-2"
      ...
      <div className="flex flex-col md:flex-row justify-between md:mt-[100px] relative z-[10]">
        <Image
          src={portfolio_3}
          alt="portfolio-3"
          className="size-[83vw] md:h-auto md:w-[40vw] mt-[40px] md:mt-0 mx-auto lg:mx-0"
        />
        <Image
          src={portfolio_4}
          alt="portfolio-4"
