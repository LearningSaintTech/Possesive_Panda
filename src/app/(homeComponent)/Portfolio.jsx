...
const Portfolio = () => {
  ...
  return (
    <div className="py-[140px] px-[7.5vw] bg-black text-white rounded-t-[40px] z-[-2]">
      <div className="flex justify-between">
        <motion.div
          className="w-[32.292vw] z-[1] sticky top-[10px]"
          style={{ y }}
        >
          ...
          <p className="text-[#F9F9F9] font-normal text-[1.25vw] tracking-[0.015rem]">
            ...
            Panda. Our creative designing services are more than just
            aesthetics.
          </p>
