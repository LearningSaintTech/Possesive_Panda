...
const Faq = () => {
  ...
  return (
    <div className="bg-[#00111A]">
      <div className="mx-[7.692vw] sm:mx-[5.208vw] flex flex-col sm:flex-row justify-center items-center min-h-fit overflow-hidden ">
        <div className="w-full sm:w-[24.15vw] h-fit justify-center items-center flex-shrink-0 text-white not-italic mb-[1.042vw] sm:mb-[7.76vw] md:mt-6 ">
