...
const Banner = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:justify-between px-[3vw] md:pl-[8.854vw] md:mr-[5.729vw] relative overflow-hidden max-h-[125vh] md:max-h-[100vh]">
      <Image
        src={shadow}
        alt="shadow"
        className="bg-custom-gradient mix-blend-hard-light filter-blur-custom absolute -left-24 -top-3 -z-[1] overflow-visible"
      />
      <div className="w-full md:w-[35.469vw] mt-[20px] md:mt-[151px] min-h-[60vh] max-h-[100vh] flex flex-col justify-evenly">
        <h1 className="text-zinc-800 text-[8.2vw] xl:text-[3.333vw] font-semibold leading-[2.5rem] md:leading-[normal] md:tracking-[0.04rem] text-center md:text-start">
          Boost Your Business With Powerful IT Technology.
        </h1>
        <p className="text-zinc-800 text-[4vw] xl:text-[1.25vw] font-normal leading-[150%] tracking-[0.24px] md:w-[28.281vw] text-center md:text-start">
          In accordance with your company's needs, Maxtra Technologies offers
          tailored app and web development solutions.
        </p>
        <div className="flex flex-col md:flex-row justify-evenly md:justify-normal gap-5 md:gap-0">
          <button className="bg-stone-900 text-[4vw] lg:text-[1.25vw] flex justify-center font-normal items-center rounded-[5vw] md:rounded-[3.4vw] border border-neutral-600 text-white px-[3vw] py-[2.5vw] md:py-[1vw]">
            Lets Start
            <svg
              width="19"
              height="15"
              ...
              className="ml-2 md:ml-5 size-[5vw] md:size-[0.8vw]"
            >
              <path
          ...
          <button className="text-[4vw] lg:text-[1.25vw] flex justify-center items-center rounded-[5vw] md:rounded-[3.4vw] border border-neutral-600 text-zinc-900 tracking-[0.013vw] ml-0 md:ml-[5%] px-[3vw] py-[2.5vw] md:py-[1vw]">
            See Services
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="19"
          ...
          >
            <li>
              <Image
                src={banner_1}
                alt="banner-1"
                className="w-[45vw] h-[52vw] md:w-[19.5vw] md:h-[29vw]"
              />
            </li>
            <li>
              <Image
      ...
      <Image
        src={panda}
        alt="panda"
        className="hidden lg:block absolute -bottom-[45%] left-[15%] z-[-20] h-auto w-auto"
      />
    </div>
  );
};
