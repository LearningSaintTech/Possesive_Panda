...
const Banner = () => {
  ...
  return (
    ...
    <div className="relative w-auto h-auto sm:h-[55.417vw] sm:overflow-hidden ">
      ...
      <div className="absolute bottom-4 sm:bottom-[10.417vw] sm:px-2 px-[7.69vw] z-10 sm:text-left py-2 sm:right-[6.25vw]">
        <h1 className='sm:w-[15.208vw] text-white text-[2.8vw] text-center sm:text-left sm:text-[1.406vw] font-normal sm:leading-[2.083vw]'>
          Trust us to keep your technology running smoothly,
          <span className='text-[#60e2ff] font-medium'> so you can focus on what truly matters</span>—growing your business.
        </h1>
