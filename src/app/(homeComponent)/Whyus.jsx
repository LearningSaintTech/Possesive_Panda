...
const WhyUs = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:justify-between md:gap-[4vw] px-[7.69vw] sm:px-[5.208vw] relative overflow-hidden max-h-[100vh] md:mt-10 md:mb-8 md:max-h-[60vh] lg:max-h-[80vh]">
