  ...
  return (
    <div className="my-[50px] lg:mt-[5.208vw] mb-[7vw] overflow-hidden bg-[#00111A]">
      <div className="flex flex-col md:flex-row justify-between items-center not-italic mx-[6.771vw]">
        <h2 className="text-white w-[80vw] lg:w-[40vw] text-center md:text-start md:w-[45vw] xl:w-[38.25vw] text-[6.154vw] sm:text-[8.1vw] md:text-[4.5vw] lg:text-[3.333vw] xl:text-[3.334vw] font-medium leading-[125%] tracking-[0.1rem] mb-[20px] lg:mb-0 ">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 w-full sm:mt-[6.656vw] mt-[10vw] sm:px-[5.2vw] px-[7.692vw]">
        {data.map((icon, key) => (
          <div
            key={key}
            className="relative w-full h-[35vw] sm:h-[10vw] flex justify-center items-center bg-[#00111A] border border-white border-opacity-35 sm:border-opacity-10 transition duration-300 sm:hover:bg-sky-500 sm:group"
          >
            <Image
              src={icon.white}
              alt={`Brand ${key}`}
              className="w-full h-[18vw] sm:h-[3.87vw] sm:w-[10vw] absolute transition-opacity duration-300 group-hover:opacity-0 object-contain table-fixed"
            />
            <Image
              src={icon.black}
              alt={`Brand ${key}`}
