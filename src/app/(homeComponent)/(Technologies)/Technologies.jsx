  ...
  return (
    <div className="my-[50px] lg:mt-[5.208vw] mb-[7vw] overflow-hidden">
      <div className="flex flex-col md:flex-row justify-between items-center not-italic mx-[6.771vw]">
        ...
        <button className="inline-flex self-start py-[15px] lg:py-[1vw] px-[3vw] lg:px-[1.563vw] mx-auto md:mx-0 md:my-auto w-fit bg-[#60E2FF] rounded-[8px] h-fit text-white text-[4.375vw] sm:text-[3.5vw] md:text-[2vw] lg:text-[1.7vw] xl:text-[1.114vw] leading-[125%] tracking-[0.063vw] font-medium hover:opacity-60">
