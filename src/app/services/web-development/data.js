import { feature, nums, service, icons } from "./image";
import banner from "../../../assets/services/banners/Web-Development-&-Design-Services.png";

const top = {
  title: "Web Development & Design Service",
  paragraph: [
    `Deliver a captivating and valuable user experience with Possesive Panda’s custom Web Development & Design Services.`,
  ],
...
export { top, leverage, howWeDevelop, topwebdevelopment, frameworks, faq };
