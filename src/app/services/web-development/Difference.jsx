    ...
    return (
        <div className="px-[5.2vw] pt-[5vw]">
            ...
            <div className="flex justify-center">
                ...
                <button
                    className={`w-[44.792vw] h-[4.167vw] rounded-tl-[0.26vw] rounded-bl-[0.26vw] shadow border border-neutral-300 text-zinc-600 text-[1.25vw] font-medium leading-[1.941vw] ${activeTab === "ios" ? "bg-gray-200" : "bg-white"
                        }`}
