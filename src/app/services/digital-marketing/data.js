...
const top = {
  ...
  paragraph2: [
    `In the current era, where the role of traditional markets is getting slow to reach the actual audience there, digital marketing plays a very crucial role in connecting you. Changes in market scenarios and the evolution of new technologies have altered how marketers engage and acquire customers.`,
...
const digitalMarketingStrategy = [
  {
    ...
    description: `As the best Online Marketing company, our prime focus is helping our clients achieve success by generating quality leads. As your Digital Marketing partner, your brand will easily reach its targeted audience and help to convert into actual customers.`,
  },
  {
    num: "2",
    title: "Increase Online Visibility",
    description: `We help you connect with the targeted audiences and make your online visibility strong. With attractive content marketing and set digital marketing campaigns that help grow brand value. Our goal is to grow your brand value.`,
  },
  {
    num: "3",
    title: "Grow Website Traffic",
    description: `We focus on high quality, we assure you that your campaigns attract the right audience. With our SEO specialists and social media marketers, we put your business in the right places.`,
  },
  {
    num: "4",
    title: "Increased Sales and ROI",
    description: `Our company creates paid and organic campaigns that help increase sales and ROI. We develop strategies for marketing and targeting, so you can target potential leads. This leads to higher satisfaction in the businesses.`,
  },
];
...
const DriveOrganisation = [
  {
    ...
    description: `The very first step in digital marketing is to identify the target market. Understanding the audience helps create relevant content and makes it easier to advertise. This also helps to reach the correct audience with the correct products. `,
    image: icons[0],
  },
  {
  ...
  },
  {
    ...
    description: `Having a well-defined strategy is very important. Strategy which is used to reach and engage with the audience include; Content Marketing, SEO, SMM, Email Marketing, and many more.`,
    image: icons[2],
  },
  {
  ...
  },
  {
    ...
    description: `Tools like Google Analytics, social media insights, and email marketing tools help marketers track the daily performance of their campaigns. This leads to understanding the flow of traffic or visits on our platforms.`,
    image: icons[4],
  },
  {
...
const digitalMarketingServices = [
  {
    ...
    description: `Compared to traditional marketing, Digital marketing is more cost-effective. Small businesses can particularly benefit from digital marketing strategies like social media Marketing, Content Marketing, SEO, PPC, and many more.`,
    image: benefit[0],
  },
  {
    title: "Global Reach",
    description: `Digital marketing helps businesses reach globally. Businesses can expand their reach significantly through the Internet and connect with potential customers anytime and anywhere. Unlike traditional marketing approaches, digital marketing has no boundaries.`,
    image: benefit[1],
  },
  {
    title: "Targeted Audience",
    description: `Digital marketing helps target a specific audience based on behaviour, interest, demographics, and more. This approach ensures to digital marketing specialists that the efforts are directed towards the audience who is most likely to be interested in the products and services.`,
    image: benefit[2],
  },
  {
    title: "Broader Engagement",
    description: `Digital Marketing helps in direct interaction and customer engagement through social media, email marketing, and blogs. This includes a two-way process that helps build strong customer relationships and brand loyalty.`,
    image: benefit[3],
  },
  {
    title: "Brand Building",
    description: `Good digital marketing strategies help to build a strong brand presence. Businesses can build trust with their viewers through SEO, social media engagement, and content marketing.`,
    image: benefit[4],
  },
];
...
const ourDigitalMarketingServices = [
  ...
  },
  {
    ...
    description: [
      `From creating engaging email templates to building targeted email lists, These emails could relate to promotional ads, new launches, discount offers, and more. By sending group emails to existing and potential customers, a business can promote its products and expand its customer base. We help businesses by creating email campaigns that enhance their relationship with their customers.`,
    ],
    image: service[2],
  },
  {
...
const easyWorkProcess = {
  ...
  paragraph: `As a best-performance and digital marketing company, we prefer to keep things simple. With our innovative process, we stand as the best digital marketing company.`,
  hilighted: `We’ve helped small businesses from scratch.`,
  cards: [
    {
      num: "1",
      title: "Understanding the Needs of the Project",
