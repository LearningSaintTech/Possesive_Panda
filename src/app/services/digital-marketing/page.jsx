  ...
  return (
    <div>
      ...
      <div className="px-[5.2vw] pt-[5.2vw]">
        ...
        <div >
          <h2 className="text-[#212121] text-[4.346vw] sm:text-[2.083vw] font-semibold leading-[normal] tracking-[0.03rem] w-[70vw] sm:w-[39vw] mt-9 sm:mt-[2vw]">
        ...
        <div className="my-[5.2vw]">
          <h2 className="text-[#212121] text-[4.364vw] sm:text-[2.083vw] font-semibold capitalize leading-[normal] tracking-[0.03rem] w-[75vw] sm:w-[38vw] mt-12 sm:mt-0 sm:mb-0 mb-6">
      ...
      <div className="bg-[rgba(243,252,254,0.5)] py-[4.167vw] px-[5.2vw]">
        <h2 className="text-[#212121] text-[4.346vw] sm:text-[2.083vw] font-semibold leading-[normal] tracking-[0.03rem] w-[60vw] sm:w-[37.6vw]">
