...
// const top = {
//   title: "Benefits of E-commerce Management software",
//   paragraph: [
...
const servicesData = [
  {
    icon: <GrSettingsOption className='text-[#04b7df] w-[1.406vw] h-[2.135vw] relative' />,
    title: 'eCommerce Consulting',
    description: 'Possesive Panda delivers the best eCommerce solutions to improve your operational efficiency and user experience via consultancy from industry experts.'
  },
  {
    icon: <PiTimerBold className='text-[#04b7df] w-[1.406vw] h-[2.135vw] relative' />,
    title: 'eCommerce Implementation',
    description: 'Get cloud platforms, payment gateways, POS systems, and CRMs implemented to your eCommerce web stores and mobile applications.'
  },
  {
    icon: <IoMdGitMerge className='text-[#04b7df] w-[1.406vw] h-[2.135vw] relative' />,
    title: 'eCommerce Marketing',
    description: 'Be at the forefront of your industry with Possesive Panda’s eCommerce marketing team of experienced professionals dedicated to bespoke SEO, PPC, and social media marketing.'
  },
  {
    icon: <IoMdGitMerge className='text-[#04b7df] w-[1.406vw] h-[2.135vw] relative' />,
    title: 'eCommerce SEO',
    description: 'Possesive Panda delivers the best SEO professionals to boost up your sales and traffic to your eCommerce website, providing exceptional on-page, off-page, and local SEO strategies.'
  },
  {
    icon: <IoMdGitMerge className='text-[#04b7df] w-[1.406vw] h-[2.135vw] relative' />,
    title: ' eCommerce Web Design',
    description: 'At Possesive Panda, we conduct thorough research and invest time to make sure that you will get a tailored and customized eCommerce website design.'
  },
  {
    icon: <IoMdGitMerge className='text-[#04b7df] w-[1.406vw] h-[2.135vw] relative' />,
    title: ' eCommerce Web Development',
    description: ' With the use of new technologies and experienced developers, Possesive Panda’s eCommerce website development delivers scalable, secure, and well-performing solutions.'
  },
];
