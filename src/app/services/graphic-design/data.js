...
const top = {
  ...
  paragraph: [
    `Enhance your brand's visual communication capabilities with custom graphic design services by Possesive Panda.`,
  ],
