        ...
        <div className='relative flex flex-col bg-[#00111A] gap-[3.646vw] sm:px-[5.208vw] sm:py-[6.25vw] px-[7.059vw] py-[14.118vw] '>
            ...
            <div className='flex'>
                <div className='flex flex-col gap-[2.824vw] sm:gap-[1.042vw]'>
                    <p className='text-white text-[3.765vw] sm:text-[1.25vw] font-normal text-center sm:text-justify'>
                        {subText1}
                    </p>
                    <p className='text-white text-[3.765vw] sm:text-[1.25vw] font-light w-[55.729vw]'>
                        {subText2}
                    </p>
                </div>
                <Image
