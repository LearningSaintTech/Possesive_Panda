    ...
    return (
        <div className='px-[5.208vw] bg-[#00111a]'>
            <div className='flex flex-col items-center justify-center gap-[1.25vw]'>
                <h5 className='sm:font-medium font-medium sm:text-[2.5vw] text-[7.529vw] sm:w-[44.271vw] w-[85.882vw] text-center text-white'>
            ...
            >
                <div className={`relative w-[85vw] mt-[2.5vw] ${isRevealed ? 'group' : ''}`}>
                    {/* Cards */}
                    <div className={`absolute shadow-2xl w-[21.458vw] h-[26.313vw] bg-[#131d22] py-[3.498vw] px-[3.047vw] flex flex-col gap-[1vw] rounded-[0.625vw] transition-all duration-500 ${isRevealed ? 'translate-x-0 translate-y-0' : ''}`} style={{ zIndex: 4 }}>
                    ...
                    <div className={`absolute shadow-2xl w-[21.458vw] h-[26.313vw] bg-[#131d22] py-[3.498vw] px-[3.047vw] flex flex-col gap-[1vw] rounded-[0.625vw] transition-all duration-500 ${isRevealed ? 'translate-x-[22.708vw] translate-y-0' : 'translate-x-[1vw] translate-y-[1vw]'}`} style={{ zIndex: 3 }}>
                        <h5 className='text-[1.875vw] font-normal text-white text-center'>
                            Scrum
                        </h5>
                        <p className='w-[15.365vw] text-center text-white text-[1.25vw] font-normal'>
            ...
            <div className='md:hidden'>
                ...
                <div className='flex flex-col gap-[3.765vw] w-full mt-[10.588vw]'>
                    ...
                    <div className='w-[85.882vw] h-[52.706vw] bg-[#131d22] py-[3.498vw] px-[3.047vw] flex flex-col gap-[6.353vw] rounded-[0.625vw]'>
                        <h5 className='text-[7.529vw] font-normal text-white text-center'>
                            Agile Approach
                        </h5>
