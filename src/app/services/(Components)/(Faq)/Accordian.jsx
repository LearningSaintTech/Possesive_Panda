...
const Accordian = ({ title, children, index, activeIndex, setActiveIndex }) => {
  ...
  return (
    <>
      ...
      >
        <p className="text-black text-[4vw] md:text-[2vw] lg:text-[1.25vw] xl:text-[1.25vw] font-normal leading-[normal] tracking-[0.013vw] my-auto">
          {title}
        </p>
      ...
      <div
        className={`overflow-hidden text-[3.7vw] md:text-[2vw] lg:text-[1.25vw] xl:text-[1.25vw] ml-[1.2vw] sm:ml-0`}
        style={{
          height: isOpen ? accordianRef.current?.scrollHeight : "0px",
          transition: "height 0.7s ease-in-out",
        }}
      >
        <div className="px-[0.6vw] py-0 mb-[1.51vw] mt-0" ref={accordianRef}>
          {children}
        </div>
      </div>
    </>
