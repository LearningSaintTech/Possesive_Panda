...
const Accordian = ({ title, children, index, activeIndex, setActiveIndex }) => {
  ...
  return (
    <>
      ...
      >
        <p className="text-black text-[4vw] md:text-[2vw] lg:text-[1.5vw] xl:text-[1.25vw] font-medium leading-[normal] tracking-[0.013vw] my-auto">
          {title}
        </p>
      ...
      <div
        className={`overflow-hidden text-[3.7vw] md:text-[2vw] lg:text-[1.5vw] xl:text-[1.25vw] ml-[1.2vw] sm:ml-0`}
        style={{
