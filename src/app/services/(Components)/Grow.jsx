...
const Grow = ({ data }) => {
  return (
    <div className={`rounded-[1vw] sm:rounded-[0.52vw] border border-[rgba(146, 142, 142, 0.50)] shadow-lg relative px-[3vw] sm:px-[0.78vw] sm:min-w-[21.46vw]`}>
      ...
      <h6 className="text-[#212121]  text-[4vw] sm:text-[1.15vw] leading-[137.835%] mt-[15vw] sm:mt-[6.78vw] mb-[2vw] sm:mb-[0.521vw] capitalize">
        {data.title}
      </h6>
      <p className="text-[#1E1E1E] text-[3.636vw] sm:text-[1.042vw] leading-[137.835%] tracking-[0.013rem] opacity-60 mb-[5vw] sm:mb-[2.8vw] w-full">
        {data.description}
      </p>
    </div>
  );
