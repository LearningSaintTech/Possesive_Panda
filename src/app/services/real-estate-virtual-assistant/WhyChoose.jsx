        ...
        <div className="bg-[#00111A] flex px-[5.208vw]  relative">
            ...
            <div className=" flex flex-col w-[39.583vw] h-[22.083vw] absolute bottom-0 right-[5.208vw] pt-[2.813vw] pb-[4.635vw] pl-[2.604vw] pr-[2.5vw] bg-gradient-to-b from-[rgba(255,255,255,0.65)] to-[rgba(153,153,153,0.40)]">
                <div className="flex gap-[0.729vw] items-center ">
                    <span className="text-[#00aff1] text-[7.813vw] leading-none font-semibold">{slides[currentSlide].number}</span>
                    <div className="flex flex-col">
                        <h3 className="text-white text-[1.667vw] font-medium">{slides[currentSlide].title}</h3>
                        <div className="h-[0.052vw] w-[22vw] bg-black mt-[1vw]" /> {/* Line */}
                    </div>
                </div>
                ...
                <div className="absolute bottom-[0.833vw] right-[0.833vw] flex space-x-2">
                    <button onClick={prevSlide} className="p-[0.586vw] bg-[#212121] rounded-full">
                        <FaChevronLeft className="text-white w-[1vw] h-[1vw] " />
                    </button>
                    <button onClick={nextSlide} className="p-[0.586vw] bg-[#212121] rounded-full">
    ...
    const MobileView = () => (
        <div className="bg-[#00111A] px-[7.059vw] pt-[10.412vw] pb-[7.059vw] relative">
            ...
            <div className="relative bg-gradient-to-b from-[rgba(255,255,255,0.65)] to-[rgba(153,153,153,0.40)] p-[5.647vw] rounded-tl-[7.059vw] rounded-tr-[7.059vw] mt-[-7.059vw] ">
                ...
                <p className="text-white text-[3.765vw] font-normal mb-[5.647vw]">{slides[currentSlide].description}</p>
                <div className="flex justify-between">
                    <button onClick={prevSlide} className="p-[1.882vw] bg-[#212121] text-white rounded-full">
                        <FaChevronLeft size={20} />
                    </button>
                    <button onClick={nextSlide} className="p-[1.882vw] bg-[#212121] text-white rounded-full">
