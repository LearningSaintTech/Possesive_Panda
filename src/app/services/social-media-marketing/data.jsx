...
const whyData = {
  ...
  thumbnail: '/assets/services/social-media/7.png',
  listHeading:
...
const ourService = {
  ...
  subHeading:
    "Possesive Panda offers a full suite of Social Media Marketing (SMM) services for your business growth. Thrive on our SMM Services for better ROI and ROAS.",
};
